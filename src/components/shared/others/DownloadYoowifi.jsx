...
function DownloadYoowifi() {
  return (
    <section className="py-[60px] pt-0 px-4 bg-main-600 relative overflow-hidden">
      <YooWifiLogoIcon className="absolute top-1/2 left-0 -translate-y-1/2 z-[1] w-[326px] md:w-[880px] h-full" />
      <div className="w-full max-w-[1220px] mx-auto relative z-[2]">
        <div className="w-full max-w-[650px] sec_common_60">
          <h2 className="text-base md:text-3xl font-semibold text-status-alert leading-[120%] uppercase">
            Download the
          </h2>
          <h3 className="text-5xl md:text-[5rem] font-extrabold text-white mt-1 md:mt-4">
            Yoowifi
          </h3>
          ...
          <div className="mt-10 flex flex-col md:flex-row items-start lg:items-center gap-10">
      ...
      <div className="absolute bottom-0 right-[-5%] h-auto w-[60%] md:w-[50%] z-[2]">

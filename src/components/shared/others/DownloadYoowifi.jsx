...
function DownloadYoowifi() {
  return (
    <section className="pt-0 px-4 bg-main-600 relative overflow-hidden">
      ...
      <div className="w-full max-w-[1220px] mx-auto relative z-[3] sec_common_60 xl:px-0">
        <div className="w-full max-w-[400px] md:max-w-[650px] mb-9 md:mb-0 px-0 md:px-10 lg:px-0 relative z-[3]">

                ...
                <div className='mt-4 md:mt-10 grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-10 xl:gap-[76px]'>
                    <div className='order-2 md:order-1'>
                        <div className='space-y-2 md:space-y-6'>
                            {topUpData.map((item, index) => (<article key={index} className='border border-neutral-300 rounded-xl md:rounded-3xl px-4 py-6 md:px-6'>
                        ...
                        <div className='mt-4 md:mt-8'>
                            <Button variant="secondary" className="!h-11 md:!h-[51px] w-[211px]" onClick={() => navigate('/contact')}>
                                Contact Us
                            </Button>
                        </div>
                    </div>

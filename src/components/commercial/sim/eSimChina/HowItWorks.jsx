    ...
    <section className="containerX sec_common_60 px-4 md:px-6 xl:px-0 flex flex-col items-center gap-6 md:gap-10 lg:gap-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
        {howItWorksData.map((item, index) => (
          ...
          <div
                className=
                  "rounded-xl md:rounded-2xl bg-neutral-100 py-6 md:py-10 px-4 md:px-6  w-full flex flex-col justify-between"
                  
              >
                <div className="">
                  <div className="h-14 md:h-20 w-14 md:w-20 rounded-lg md:rounded-xl bg-white flex_center">
                    {item.icon}
                  </div>
                  ...
                  <h2
                    ...
                    title={item.title}
                  >
                    {t(`howItWorks.howItWorksData.${index}.title`)}
                  </h2>
          
                  <p className="text-sm md:text-[18px] text-black-600 !leading-[1.4] mt-2 md:mt-3">
                    {t(`howItWorks.howItWorksData.${index}.description`)}
                  </p>
                </div>

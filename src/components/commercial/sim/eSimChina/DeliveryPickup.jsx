...
const DeliveryPickup = () => {
  ...
  return (
    <section className="containerX sec_common_60 px-4 md:px-6 xl:px-0 flex flex-col items-center gap-6 md:gap-10 lg:gap-20">
      <SectionHeader
        heading={t("eSimChina.deliveryPickup.title")}
        subHeading={t("eSimChina.deliveryPickup.titlefollow")}
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              <div className="">
                <h2
                  ...
                  title={item.title}
                >
                  {t(`eSimChina.deliveryPickup.steps.${index}.title`)}
                </h2>

                <p className="text-sm md:text-[18px] text-black-600 !leading-[1.4] mt-2 md:mt-3">
                  {t(`eSimChina.deliveryPickup.steps.${index}.description`)}
                </p>
              </div>
            </div>
          </div>
